...
#[derive(Clone, Debug, CandidType, Deserialize)]
pub struct SetModelContentArguments {
    pub key: AssetKey,
    pub content_encoding: String,
    pub set_content_count: usize,
    pub now: u64,
}

#[derive(Clone, Debug, CandidType, Deserialize)]
pub struct SetModelContentResponse {
    pub total_chunks_length: u32,
    pub current_chunks_length: u32,
}
